          ...
          ">
                        ...
                        " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    @if($fieldDate)
                                        <th scope="col"
                                            ...
                                            <div class="flex">Fecha<svg class="h-4 w-4 @if($sortField!='date')
                        opacity-0
                        @endif
                        @if($sortDirection=='desc')
                        rotate-180
                    ...
                    @if(in_array($product->id, $selecteds))
                        ...
                        @endif">
                                        ...
                                        @endif
                                        @if($fieldDate)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->date }}</div></td>
                                        @endif
                                        @if($fieldType)
                                        ...
                                        <div class="sm:flex place-content-around m-2">
                                            <div>
                                                ...
                                                <div class="sm:col-span-6">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" id="bills_id" wire:model.lazy="bills_id" name="bills_id"
                                                               class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5" />
                                                    </div>
                                                ...
                                                <div class="sm:col-span-6">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" id="ammount" wire:model.lazy="ammount" name="ammount"
                                                               class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5" />
                                                    </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="sm:col-span-6">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" id="date" wire:model.lazy="date" name="date"
                                                               class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5" />
                                                    </div>
