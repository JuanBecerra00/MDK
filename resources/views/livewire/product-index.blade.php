          ...
          ">
                    ...
                    @if(in_array($product->id, $selecteds))
                        ...
                        @endif">
                                        ...
                                        @endif
                                        @if($fieldType)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->type }}</div></td>
                                        @endif
                                        @if($fieldCc)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->cc }}</div></td>
                                        @endif
                                        @if($fieldName)
                                        ...
                                        @if($fieldJob)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">
                                                    @if($product->job=='A')
                                                        Administrador
                                                    @elseif($product->job=='T')
                                                        Trabajador
                                                    @elseif($product->job=='M')
                                                        Mecanico
                                                    @endif
                                                </div>
                                            </td>
                                        @endif
                                        @if($fieldEmail)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->email }}</div></td>
                                        @endif
                                        @if($fieldPhone)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->phone }}</div></td>
                                        @endif
                                        @if($fieldQuestion)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->question }}</div></td>
                                        @endif
                                        @if($fieldAnswer)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $product->answer }}</div></td>
                                        @endif
                                        @if($fieldStatus)
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($product->status=='1')
