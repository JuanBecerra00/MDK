<table class="min-w-full divide-y divide-gray-200">
        ...
        @foreach($users as $user)
                    <tr class="">
                      <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $user->id }}
                    U</div></td>a
                    </tr>
                    @endforeach
                    @foreach($vehicles as $vehicle)
                    <tr class="">
                      <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $vehicle->id }}V</div></td>a
                    </tr>
                    @endforeach
        </tbody>
      </table>