                    ...
                    <div class="flex max-sm:flex-col gap-5 items-center">
                        ...
                        <span class="inline-flex rounded-md">
                                ...
                                <x-slot name="content">
                                    ...
                                    <button class="grid grid-cols-2 w-full text-start block px-4 py-2 text-sm leading-5 text-white hover:bg-zinc-700 focus:outline-none focus:bg-zinc-900 transition" wire:click="changeField('fieldCustomers_id')">
                                        <p class="">Id del cliente</p>
                                        <input type="checkbox" class="checked:bg-red-800 focus:ring-red-800 text-red-800 justify-self-center" @if($fieldCustomers_id) checked @endif>
                                    </button>
                                    <button class="grid grid-cols-2 w-full text-start block px-4 py-2 text-sm leading-5 text-white hover:bg-zinc-700 focus:outline-none focus:bg-zinc-900 transition" wire:click="changeField('fieldPlate')">
                                        <p class="">Placa</p>
                                        <input type="checkbox" class="checked:bg-red-800 focus:ring-red-800 text-red-800 justify-self-center" @if($fieldPlate) checked @endif>
                                    </button>
                                    <button class="grid grid-cols-2 w-full text-start block px-4 py-2 text-sm leading-5 text-white hover:bg-zinc-700 focus:outline-none focus:bg-zinc-900 transition" wire:click="changeField('fieldModel')">
                                        <p class="">Modelo</p>
                                        <input type="checkbox" class="checked:bg-red-800 focus:ring-red-800 text-red-800 justify-self-center" @if($fieldModel) checked @endif>
                                    </button>
                        ...
                        <span class="inline-flex rounded-md">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <a href="/vehiclesExportPdf/{{$this->encryption}}" target="blank">
          ...
          ">
                        ...
                        " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    @if($fieldPlate)
                                        <th scope="col"
                                            ...
                                            <div class="flex">Placa<svg class="h-4 w-4 @if($sortField!='plate')
                        opacity-0
                        @endif
                        @if($sortDirection=='desc')
                        rotate-180
                        ...
                        " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    @if($fieldModel)
                                        <th scope="col"
                                            ...
                                            <div class="flex">Modelo<svg class="h-4 w-4 @if($sortField!='modelo')
                        opacity-0
                        @endif
                        @if($sortDirection=='desc')
                        rotate-180
                        ...
                        " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @foreach($vehicles as $vehicle)
                                    <tr class="
                    @if(in_array($vehicle->id, $selecteds))
                        bg-zinc-300
                        @endif">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="checkbox" wire:change="addToSelecteds({{ $vehicle->id }})" class="checked:bg-red-800 focus:ring-red-800 text-red-800"
                                                   @if(in_array($vehicle->id, $selecteds))
                                                       checked
                                            @endif">
                                        </td>
                                        @if($fieldId)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $vehicle->id }}</div></td>
                                        @endif
                                        @if($fieldCustomers_id)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $vehicle->customers_id }}</div></td>
                                        @endif
                                        @if($fieldPlate)
                                            <td class="px-6 py-4 whitespace-nowrap"><div class="max-w-[12rem] overflow-x-auto">{{ $vehicle->plate }}</div></td>
                                        @endif
                                        @if($fieldModel)
                                        ...
                                        @if(Auth::user()->job=='A')
                                            <td class="px-6 py-4 text-right text-sm flex justify-center gap-2">
                                                <x-jet-button wire:click="showEditVehicleModal({{ $vehicle-> id }})"
                                        ...
                                        <div class="sm:flex place-content-around m-2">
                                            <div>
                                                <div class="sm:col-span-6">
                                                    <label for="customers_id" class="block text-sm font-medium text-gray-700"> Id del cliente </label>
                                                    <div class="mt-1">
                                                        <input type="number" id="customers_id" wire:model.lazy="customers_id" name="customers_id"
                                                    ...
                                                    @error('customers_id') <span class="error text-red-500">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="sm:col-span-6">
