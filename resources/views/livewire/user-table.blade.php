<div class="flex justify-center mt-20" style="font-size:{{ $this->fontSize }}px">
  ...
  <h1 style="font-size: 30px;" class="text-white">Usuarios</h1>
                  ...
                  <form enctype="multipart/form-data">
                    ...
                    <div class="sm:flex place-content-around m-2">
                      <div>
                        ...
                        <div class="sm:col-span-6">
                          <label for="job" class="block text-sm font-medium"> Cargo </label>
                          <div class="mt-1">
                      ...
                      <div class="sm:col-span-6">
                        <label for="cpassword" class="block text-sm font-medium"> Confirmar Contraseña</label>
                        <div class="mt-1">
