...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-4 border-red-800 text-sm font-medium leading-5 text-white focus:outline-none focus:border-indigo-700 transition'
