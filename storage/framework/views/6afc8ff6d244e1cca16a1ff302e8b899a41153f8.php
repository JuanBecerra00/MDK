...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-red-800 text-base font-medium text-white bg-zinc-700 focus:outline-none focus:text-zinc-200 focus:bg-zinc-600 focus:border-red-900 transition'
...
<?php /**PATH C:\laragon\www\MDK\resources\views/vendor/jetstream/components/responsive-nav-link.blade.php ENDPATH**/ ?>
