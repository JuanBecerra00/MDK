...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="px-4 py-5 sm:p-6 bg-white dark:bg-zinc-700 shadow sm:rounded-lg">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\MDK\resources\views/vendor/jetstream/components/action-section.blade.php ENDPATH**/ ?>
