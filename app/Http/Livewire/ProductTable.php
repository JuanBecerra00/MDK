...
class ProductTable extends Component
{
    ...
    public function selectAll($value)
    {
        $products = Product::where('name', 'like', '%'.$this->search.'%')->where('status', 'like', '%'.$this->filter.'%')
            ...
            ->orwhere('date', 'like', '%'.$this->search.'%')->where('status', 'like', '%'.$this->filter.'%')
    ...
    {
        return Excel::download(new ProductsExport($this->selecteds, $this->fieldId, $this->fieldProviders_id, $this->fieldBills_id, $this->fieldName, $this->fieldAmmount, $this->fieldPrice, $this->fieldDate, $this->fieldType, $this->fieldStatus), 'products.xlsx');
    }
    public function exportCsv()
    {
        return Excel::download(new ProductsExport($this->selecteds, $this->fieldId, $this->fieldProviders_id, $this->fieldBills_id, $this->fieldName, $this->fieldAmmount, $this->fieldPrice, $this->fieldDate, $this->fieldType, $this->fieldStatus), 'products.csv');
    }
    ...
    public function pdf($exportData)
    {
        ...
        $pdf = PDF::loadView('exports.pdf', compact('products'),['exportData' => $exportData]);
