...
class ProductsExportPdf implements FromQuery, WithHeadings
{
    /**
    ...
    public $fieldsEs = [];
    public $toExport;
    public function __construct($selecteds, $fieldId, $fieldProviders_id, $fieldBills_id, $fieldName, $fieldAmmount, $fieldPrice, $fieldUpdated_at, $fieldType, $fieldStatus)
    {
        $this->selecteds = $selecteds;
        $i = 0;
        $lfields = ['Id', 'Providers_id', 'Bills_id', 'Name', 'Ammount', 'Price', 'Updated_at', 'Type', 'Status'];
